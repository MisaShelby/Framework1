            ...
            for (Part part : parts) {
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if (field.getName().equals(part.getName())) {
                        if (field.getType().getName().equals("etu1759.framework.FileUpload")) {
